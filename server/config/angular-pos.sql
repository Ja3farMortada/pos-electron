...
INSERT INTO `chart_of_accounts` VALUES (15, '101', 'Capital Account', NULL, 1, '10', 'EQUITY');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `exchange_rate` VALUES (1, 90000, '2024-08-24 08:35:48', 0);
COMMIT;
...
CREATE TABLE `journal_vouchers` (
  ...
  `journal_notes` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `settings` VALUES (1, '', '', '', '', '', '', '', 1, 0, 'Thank you for choosing us.');
COMMIT;
...
CREATE TABLE `sticky_notes` (
  ...
  `note_index` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `users` VALUES (7, 'admin', '$2a$10$QmR5EBArlKV8Gd7Rh3mEJOm/xvVMbLq8nyVpfotKSX0ZINskrXArW', 'admin', 'admin', 'admin', '2025-06-25 23:18:20', 1, 1, 1, 1, 1, 0);
INSERT INTO `users` VALUES (12, 'user', '$2a$10$SBVxcnDHuoCKE9U44sL/o.ZNkyYJlcJXXfmsfx2bCZLzlRX9Q5N0C', 'user', 'user', 'user', '2025-06-23 15:02:54', 0, 0, 0, 0, 0, 0);
COMMIT;
